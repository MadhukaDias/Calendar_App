...
public class CalendarApp extends JFrame {
    ...
    private void addEvent() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (title.isEmpty() || startTime.equals(endTime)) {
    ...
    private boolean isEventOverlapping(Event newEvent, LocalDate thisDate) {
        ...
        for (Event existingEvent : dailyEvents) {
            if (!((newEvent.endTime.isBefore(existingEvent.startTime)||(newEvent.endTime.equals(existingEvent.startTime))) || (newEvent.startTime.isAfter(existingEvent.endTime))||(newEvent.startTime.equals(existingEvent.endTime)))) {
                return true;
            }
        }
        return false;
    ...
    private void editEvent() {
        ...
        if (selectedEvent != null) {
            ...
            timeComboBox1.setSelectedItem(selectedEvent.startTime.toString());
            timeComboBox2.setSelectedItem(selectedEvent.endTime.toString());
